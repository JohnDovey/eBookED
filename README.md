...
- PDF export doesn't yet use a book's selected CSS template/fonts — it renders with a fixed default typeface. Tables, images inside chapter body text, and code blocks aren't rendered in the PDF or the Word export yet.
